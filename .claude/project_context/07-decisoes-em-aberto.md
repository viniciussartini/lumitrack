...
> Resolvidas: token storage (ADR-0002), método de MFA (ADR-0003), módulos de domínio do monólito (ADR-0004), design system do produto (ADR-0005) e estratégia de migração para o Industry — incremental por fase do roadmap (ADR-0006).
