...
- RF36 `[implementado]`: o sistema deve suportar a modalidade Tarifa Branca para o Grupo B, incluindo o alerta de quando ela sai mais cara que a Convencional para o perfil de consumo do usuário.
- RF49 `[implementado]`: o sistema deve comparar o custo na tarifa Convencional com o custo na Tarifa Branca a partir do consumo real do próprio usuário, respondendo "vale a pena aderir?", com alerta quando a Branca sai mais cara. *(Mesmo papel de RF35 para o Mercado Livre: recalcula o mesmo consumo real medido nos dois cenários — decomposição por posto da Branca vs. tarifa plana da Convencional — para a propriedade já na modalidade WHITE; não é uma simulação para quem ainda está na Convencional, que precisaria primeiro migrar o cadastro para poder comparar. Cobre a parte final de RF36, "incluindo o alerta".)*
