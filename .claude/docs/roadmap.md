...
| **24** | **Análise — consumo e custos (reestruturação de `/propriedades`)** | Planejada — fase atual, detalhada (3 itens) |
...
> **Registro de fechamento (a preencher ao concluir a fase):** ao mesclar o PR, seguir a convenção de 2026-09-17 — fechar o épico à mão (`Closes #N` só fecha na branch default).
