...
| Categorias de dados | Endereço, cidade, estado, CEP (campos opcionais — cifrados em repouso, ver "Medidas de segurança"); grupo/subgrupo/modalidade tarifária e demanda contratada (kW), classe de faturamento e modalidade do Grupo B (Convencional/Branca) e o booleano de desconto de faturamento (`receivesBillingDiscount` — recebe baixa renda ou outro desconto, sem taxonomia de subclasse) — enquadramento comercial e socioeconômico da unidade consumidora, não dado sensível do Art. 5º II, mas ainda dado pessoal comum por estar vinculado ao titular via a mesma linha. |
