...
export const createMeterSchema = z.discriminatedUnion("protocol", [
    z.object({
        ...nameField, ...targetFields, ...extraField,
...
export const updateMeterSchema = z.discriminatedUnion("protocol", [
    z.object({ ...nameField, ...extraField, protocol: z.literal("MQTT"), host: z.string().min(1), port: z.number().int().min(1).max(65535), topic: z.string().min(1), address: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("MODBUS_TCP"), host: z.string().min(1), port: z.number().int().min(1).max(65535), address: z.string().min(1), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("MODBUS_RTU"), address: z.string().min(1), host: z.undefined().optional(), port: z.undefined().optional(), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("ETHERNET_IP"), host: z.string().min(1), port: z.number().int().min(1).max(65535).optional(), address: z.string().optional(), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("PROFIBUS"), address: z.string().min(1), host: z.undefined().optional(), port: z.undefined().optional(), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("PROFINET"), host: z.string().min(1), port: z.number().int().min(1).max(65535).optional(), address: z.string().optional(), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("RS232"), address: z.string().min(1), host: z.undefined().optional(), port: z.undefined().optional(), topic: z.undefined().optional() }),
    z.object({ ...nameField, ...extraField, protocol: z.literal("RS485"), address: z.string().min(1), host: z.undefined().optional(), port: z.undefined().optional(), topic: z.undefined().optional() }),
])
