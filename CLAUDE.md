...
- `.claude/docs/` — documentação técnica: os documentos históricos do projeto migrados de `docs/` (auditoria, runbook, planos e logs — nomes originais preservados, ver `.claude/docs/README.md`), relatórios de auditoria **novos** do kit (`YYYY-MM-DD-<tipo>-audit.md`), o roadmap vivo (`roadmap.md`), o procedimento de deploy (`DEPLOY.md`) e ADRs em `.claude/docs/adr/` (numerados `0001-titulo.md`).
